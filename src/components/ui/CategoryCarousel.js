...
const getCategoryImage = (name) => {
    ...
    if (lower.includes("necklace") || lower.includes("pendant")) return "/products/necklace.avif";
    if (lower.includes("bracelet") || lower.includes("bangle")) return "/products/bracelate.webp";
        ...
        <div className="relative group/carousel w-full py-10">
            ...
            >
                {apiCategories.map((cat) => {
                    ...
                    const path = `/jewelry?category=${encodeURIComponent(dbCat)}`;
